...
class Post(models.Model):
    ...
    views = models.ManyToManyField(BasicUser, related_name='views', blank=True, null=True)
    liked = models.ManyToManyField(BasicUser, related_name='liked', blank=True, null=True)
