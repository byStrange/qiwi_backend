...
from .views import RegionsList, Region, RegisterView, UsersList, PostView, PostDetailView, PostLikeView, PostViewView, LoginView, TestView
...
urlpatterns = [
    ...
    path("categories/", TestView.as_view(), name="test_view"),
